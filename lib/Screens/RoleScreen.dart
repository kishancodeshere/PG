        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              //required String text,required IconData icon,required bool isPasswordType,required TextEditingController controller,required double size}
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [reuseImage(),],),
              const Text(
                'Welcome To PG Guide...!', style: TextStyle(fontSize: 25, fontWeight: FontWeight.w400),),
